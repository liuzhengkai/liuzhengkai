...
export default {
  ...
  methods: {
    initBgColor() {
      if (this.taroEnv != 'h5' && this.titleBO.isOpenBgBlue == true) {//默认蓝色
        this.titleBO.TBBg.color = '#5db2ff'
      } else if (this.taroEnv != 'h5' && this.titleBO.isOpenBgBlue) {//指定颜色
        this.titleBO.TBBg.color = this.titleBO.isOpenBgBlue
      }//else无色
    },

<template>
    <view :class="prohibit ? 'preventTouchMove' : 'root'">
        ...
        <view class="list" v-else>
			<image class="ds_bill_topBg" src="../../images/ds_bill_topBg.png"/>
			<TitleBar :title-bar-obj="titleBarObj" @goBack="goBack"/>
            <view class="list_content">
                ...
                <view class="scrollBox">
                    <view class="consInfo">
                        <view class="userName">
                            <text>{{consName}}</text>
                            <image @tap="openMark" class="ds_bill_change" src="../../images/ds_bill_change.png"></image>
                        </view>
            ...
            <view class="footer">
                <view class="GuidingLanguage">
                    <view class="downLoad">下载网上国网APP</view>
                    <view>超多用电信息等你来查～</view>
                </view>
                <image class="ds_bill_buttonBg" src="../../images/ds_bill_buttonBg.png"></image>
            </view>
        </view>  

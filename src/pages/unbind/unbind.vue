<template>
  <view class="unbind-wrap">
    <!-- <image
      class="unbind_bg"
      src="../../assets/images/ds_topBg.png"
    /> -->
    ...
    <view style="position:absolute;z-index:2;">
      <view action="" class="unbind-form">
        ...
        <view class="tips-box">
          ...
          <view class="tips-content">
            <image class="leftArrow" src="../../assets/images/ds_unbind.png" />
        ...
        <view class="unbind-content padb-30">
          ...
          <view class="getcode-btn">
            <view class="code-box">
              <view v-if="!showTimes" class="getcode-text" style="color: #11A9B0" @tap="getCode">
                获取验证码
              </view>
      ...
      <view class="unbind-btn" :class="[code.length != 6 || !secretPhone ? 'unbind-btn-forbid' : '']" @tap="handleValidatePhone">
        确认
      </view>
    </view>
